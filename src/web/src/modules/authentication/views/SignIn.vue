            ...
            <v-col lg="7" style="background-color: #f9f4d4" class="d-none d-md-flex align-center justify-center">
              <div class="d-none d-sm-block">
                ...
                <div class="align-center pa-6">
                  <h2 class="text-h5 mb-2" style="line-height: 40px">Incident Recorder</h2>
                  <h6 class="text-subtitle-1 mt-0">Yukon Government</h6>
                </div>
              </div>
            </v-col>
            <v-col lg="5">
              <div class="pa-7 pa-sm-12">
                <div style="background-color: #f9f4d4" class="pa-5 d-md-none">
                  ...
                  <h2 class="display-1 font-weight-medium" style="line-height: 40px">Incident Recorder</h2>
                  <h6 class="text-subtitle-1 mt-4 op-5 font-weight-regular">Yukon Government</h6>
                </div>
